    ...
    return (
        <FormContainer>
            ...
            <Form onSubmit={submitHandler}>
                ...
                <Button type="submit" variant="primary" onClick={() => setMessage(null)}>Register</Button>
            </Form>
            <Row className="py-3">
                <Col>Already Have An Accont?<Link to={redirect ? `/login?redirect?=${redirect}` : `/register`}>
                    Login</Link></Col>
            </Row>
